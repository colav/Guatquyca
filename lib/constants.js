...
export const PLOTLIST = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: "percentage", // "set" in the future, when we implement the Venn diagram.
      },
      {
        title:
  ...
  },
  {
    ...
    children: [
      {
        title: "Número de productos realizados según el sexo",
        value: "products_by_author_sex",
        text: (
          <p>
            Conteo del atributo sexo de los autores según información disponible
            en la base de datos Scienti enriquecida con las bases de datos de
            ImpactU. Se consideran las categorías hombre, mujer, intersexual y
            sin información.
          </p>
        ),
        type: "percentage",
      },
      {
        ...
        value: "products_by_author_age_range",
        text: (
          <p>
            Conteo del atributo rango de edad de los autores según información
            disponible en la base de datos Scienti enriquecida con las bases de
            datos de ImpactU. Se consideran los siguientes rangos: 14-26, 27-59,
            60+, sin información.
          </p>
        ),
        type: "percentage",
