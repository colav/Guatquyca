...
export const GROUPS_RANKING_ORDER = ["A1", "A", "B", "C", "D", "Reconocido"];

export const NO_AUTOCOMPLETE_TYPES = ["works", "patents", "projects"];

export const AUTOCOMPLETE_URLS = {
  person: (input) => `/app/completer/person/${encodeURIComponent(input)}`,
  source: (input) => `/app/completer/source/${encodeURIComponent(input)}`,
  affiliations: (input) =>
    `/app/completer/affiliations/${encodeURIComponent(input)}`,
};
...
export const GROUP_RANK_COLORS = {
  A1: "purple",
  A: "geekblue",
  B: "blue",
  C: "cyan",
...
export const PLOTLIST = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: "Evolución anual del cuartil de SCimago",
        value: "annual_scimago_quartile",
        text: (
          <p>
            Este gráfico presenta la evolución anual del cuartil SCImago de una
            revista, mostrando el cuartil que ocupó en el ranking de SCImago en
            cada año disponible. El cuartil es una medida ordinal que refleja la
            posición relativa de la revista dentro de su área temática, donde Q1
            corresponde al nivel más alto y Q4 al más bajo.
            <br />
            La visualización permite identificar cambios, estabilidad o mejoras
            en el posicionamiento de la revista a lo largo del tiempo, con base
            en la clasificación anual publicada por SCImago. Los valores se
            interpretan únicamente para el año correspondiente y no constituyen
            una proyección futura; el cuartil se considera vigente hasta que
            exista una nueva evaluación disponible.
          </p>
        ),
        type: "evolution",
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        title:
          "Número de productos bibliográficos disponibles por tópicos (Top 20)",
        value: "products_by_subject",
        text: (
          <p>
            Este gráfico presenta los 20 tópicos con mayor número de productos
            bibliográficos en nuestra base de datos. Cada categoría corresponde
            a un tema específico, definido según la taxonomía de <b>OpenAlex</b>
            , la cual contiene cerca de 4.500 tópicos.
            <br />
            La clasificación de los productos en tópicos se realiza mediante un
            sistema automatizado de inteligencia artificial que analiza
            información como el título, el resumen, la revista de publicación y
            las citaciones. Este modelo asigna un puntaje a cada posible tópico
            y selecciona como
            <i>principal</i> el de mayor puntuación, aunque también puede
            asociar tópicos adicionales relevantes.
            <br />
            En <b>ImpactU</b>, además de aprovechar directamente la
            clasificación provista por OpenAlex, aplicamos este mismo modelo de
            inteligencia artificial a los productos provenientes de otras
            fuentes, lo que nos permite unificar y ampliar la cobertura temática
...
export const PLOTS_BY_ENTITY = {
  ...
  source: ["annual_scimago_quartile"],
};
