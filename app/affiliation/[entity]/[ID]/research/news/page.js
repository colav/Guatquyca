...
/**
 * NewsOnAffiliationsPage is a server-side functional component that fetches data based on provided parameters and displays it using
 ...
 */
export default async function NewsOnAffiliationsPage({ searchParams, params }) {
