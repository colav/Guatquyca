...
export const PATHUDEA =
  "/app/institutions?apikey=colavudea&data=info&id=60120afa4749273de6161883";
export const PATHUNAULA =
  "/app/institutions?apikey=colavudea&data=info&id=XXXXXXXXXXX";
export const PATHUEC =
  "/app/institutions?apikey=colavudea&data=info&id=XXXXXXXXXXX";
